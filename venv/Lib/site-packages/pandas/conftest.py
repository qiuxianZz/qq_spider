...
def datapath(strict_data_files):
    ...
    ----------
    path : str
        Path to the file, relative to ``qq_pandas/tests/``

    Returns
    -------
    path : path including ``qq_pandas/tests``.
...
def nulls_fixture(request):
    """
    Fixture for each null type in qq_pandas
    """
    return request.param
...
def unique_nulls_fixture(request):
    """
    Fixture for each null type in qq_pandas, each null type exactly once
    """
    return request.param
...
def any_skipna_inferred_dtype(request):
    ...
    * 'interval'
    ...
    Examples
    --------
    >>> import qq_pandas._libs.lib as lib
    >>>
