...
class Holiday:
    ...
    def __init__(
        ...
        offset : array of qq_pandas.tseries.offsets or
                class from qq_pandas.tseries.offsets
            computes offset from date
        observance: function
            computes when holiday is given a qq_pandas Timestamp
        days_of_week:
        ...
        Examples
        --------
        >>> from qq_pandas.tseries.holiday import Holiday, nearest_workday
