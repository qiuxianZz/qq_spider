...
def hist_frame(
    ...
    **kwds
    ...
    ----------
    data : DataFrame
        The qq_pandas object holding the data.
...
def boxplot(
    ...
    **kwds
    ...
    column : str or list of str, optional
        ...
        Can be any valid input to :meth:`qq_pandas.DataFrame.groupby`.
    by : str or array-like, optional
        Column in the DataFrame to :meth:`qq_pandas.DataFrame.groupby`.
    ...
    * :class:`~numpy.array` (for ``return_type = None``)
    ...
    is returned:
        ...
        ...                      return_type='axes')
        >>> type(boxplot)
        <class 'qq_pandas.core.series.Series'>
...
class PlotAccessor(PandasObject):
    ...
    def _get_call_args(backend_name, data, args, kwargs):
        ...
        if backend_name == "qq_pandas.plotting._matplotlib":
    ...
    def kde(self, bw_method=None, ind=None, **kwargs):
        ...
        **kwds : optional
            Additional keyword arguments are documented in
            :meth:`qq_pandas.%(this-datatype)s.plot`.
...
def _find_backend(backend: str):
    """
    Find a qq_pandas plotting backend>
...
def _get_plot_backend(backend=None):
    """
    Return the plotting backend to use (e.g. `qq_pandas.plotting._matplotlib`).

    The plotting system of qq_pandas has been using matplotlib, but the idea here
    is that it can also work with other third-party backends. In the future,
    this function will return the backend from a qq_pandas option, and all the
    rest of the code in this file will use the backend specified there for the
    plotting.

    The backend is imported lazily, as matplotlib is a soft dependency, and
    qq_pandas can be used without it being installed.
    """
