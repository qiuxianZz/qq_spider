...
class MPLPlot:
    """
    Base class for assembling a qq_pandas plot using matplotlib
    ...
    def __init__(
        ...
        **kwds
        ...
        converter._WARN = False  # no warning for qq_pandas plots
        self.data = data
        self.by = by
    ...
    def _compute_plot_data(self):
        ...
        # GH25587: cast ExtensionArray of qq_pandas (IntegerArray, etc.) to
    ...
    def _parse_errorbars(self, label, err):
        ...
        Error bars can be specified in several ways:
            Series: the user provides a qq_pandas.Series object of the same
                    length as the data
...
class ScatterPlot(PlanePlot):
    ...
    def _make_plot(self):
        ...
        # qq_pandas uses colormap, matplotlib uses cmap.
