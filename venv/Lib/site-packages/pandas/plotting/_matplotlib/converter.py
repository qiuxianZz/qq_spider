...
_WARN = True  # Global for whether qq_pandas has registered the units explicitly
...
def register(explicit=True):
    # Renamed in qq_pandas.plotting.__init__
    global _WARN
    ...
    for type_, cls in pairs:
        ...
        # Replace with qq_pandas converter
...
def _check_implicitly_registered():
    ...
    if _WARN:
        msg = (
            ...
            "by qq_pandas on import. Future versions of qq_pandas will require "
            "you to explicitly register matplotlib converters.\n\n"
            "To register the converters:\n\t"
            ">>> from qq_pandas.plotting import register_matplotlib_converters"
            "\n\t"
