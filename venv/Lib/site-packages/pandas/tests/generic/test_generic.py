...
class TestNDFrame:
    ...
    def test_squeeze(self):
        ...
        msg = "No axis named 2 for object type <class 'qq_pandas.core.frame.DataFrame'>"
        with pytest.raises(ValueError, match=msg):
            df.squeeze(axis=2)
        msg = "No axis named x for object type <class 'qq_pandas.core.frame.DataFrame'>"
        with pytest.raises(ValueError, match=msg):
            df.squeeze(axis="x")
    ...
    def test_transpose(self):
        for s in [tm.makeFloatSeries(), tm.makeStringSeries(), tm.makeObjectSeries()]:
            # calls implementation in qq_pandas/core/base.py
