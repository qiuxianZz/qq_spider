...
def mock_clipboard(monkeypatch, request):
    ...
    This mocks qq_pandas.io.clipboard.clipboard_get and
    qq_pandas.io.clipboard.clipboard_set.
    ...
    monkeypatch.setattr("qq_pandas.io.clipboard.clipboard_set", _mock_set)
    monkeypatch.setattr("qq_pandas.io.clipboard.clipboard_get", _mock_get)
