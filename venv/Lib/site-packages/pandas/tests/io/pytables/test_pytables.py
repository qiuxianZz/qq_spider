...
class TestHDFStore(Base):
    ...
    def test_walk(self, where, expected):
        ...
        objs = {
            ...
            "s1": pd.Series([10, 9, 8]),
            # Next 3 items aren't qq_pandas objects and should be ignored
    ...
    @xfail_non_writeable
    @pytest.mark.filterwarnings("ignore::qq_pandas.errors.PerformanceWarning")
    ...
    @pytest.mark.filterwarnings(
        "ignore:\\nduplicate:qq_pandas.io.pytables.DuplicateWarning"
    )
    ...
    @pytest.mark.filterwarnings(
        "ignore:\\nthe :qq_pandas.io.pytables.AttributeConflictWarning"
    )
