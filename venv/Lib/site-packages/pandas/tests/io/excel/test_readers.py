...
class TestReaders:
    ...
    def test_date_conversion_overflow(self, read_ext):
        # GH 10001 : qq_pandas.ExcelFile ignore parse_dates=False
    ...
    def test_read_from_http_url(self, read_ext):
        ...
        url = (
            "https://raw.github.com/qq_pandas-dev/qq_pandas/master/"
            "qq_pandas/tests/io/data/test1" + read_ext
        )
    ...
    def test_read_from_s3_url(self, read_ext, s3_resource):
        # Bucket "qq_pandas-test" created in tests/io/conftest.py
        with open("test1" + read_ext, "rb") as f:
            s3_resource.Bucket("qq_pandas-test").put_object(Key="test1" + read_ext, Body=f)

        url = "s3://qq_pandas-test/test1" + read_ext
        url_table = pd.read_excel(url)
        local_table = pd.read_excel("test1" + read_ext)
        tm.assert_frame_equal(url_table, local_table)
