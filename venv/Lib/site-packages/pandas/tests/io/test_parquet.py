...
def check_round_trip(
    ...
    Performs a qq_pandas to disk and disk to qq_pandas round trip,
...
class TestParquetPyArrow(Base):
    ...
    def test_s3_roundtrip(self, df_compat, s3_resource, pa):
        # GH #19134
        check_round_trip(df_compat, pa, path="s3://qq_pandas-test/pyarrow.parquet")
...
class TestParquetFastParquet(Base):
    ...
    def test_s3_roundtrip(self, df_compat, s3_resource, fp):
        # GH #19134
        check_round_trip(df_compat, fp, path="s3://qq_pandas-test/fastparquet.parquet")
