...
generate pickles, say its for 0.20.3, with your qq_pandas clone
in ~/qq_pandas

. activate pandas_0.20.3
cd ~/

$ python qq_pandas/qq_pandas/tests/io/generate_legacy_storage_files.py \
    qq_pandas/qq_pandas/tests/io/data/legacy_pickle/0.18.1/ pickle

This script generates a storage file for the current arch, system,
and python version
  qq_pandas version: 0.20.3
  output dir    : qq_pandas/qq_pandas/tests/io/data/legacy_pickle/0.18.1/
  storage format: pickle
created pickle file: 0.20.3_x86_64_darwin_3.5.2.pickle

The idea here is you are using the *current* version of the
generate_legacy_storage_files with an *older* version of qq_pandas to
...
def write_legacy_pickles(output_dir):
    ...
    print("  qq_pandas version: {0}".format(version))
