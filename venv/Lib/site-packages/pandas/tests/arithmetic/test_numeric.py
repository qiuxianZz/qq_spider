...
class TestDivisionByZero:
    ...
    def test_ser_divmod_zero(self, dtype1, any_real_dtype):
        ...
        # GH#27321 qq_pandas convention is to set 1 // 0 to np.inf, as opposed
...
class TestAdditionSubtraction:
    ...
    def test_series_divmod_zero(self):
        # Check that divmod uses qq_pandas convention for division by zero,
        #  which does not match numpy.
        # qq_pandas convention has
        #  1/0 == np.inf
        #  -1/0 == -np.inf
        #  1/-0.0 == -np.inf
        #  -1/-0.0 == np.inf
