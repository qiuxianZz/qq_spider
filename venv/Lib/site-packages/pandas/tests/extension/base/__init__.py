...
.. code-block:: python
   ...
   import pytest
   from qq_pandas.tests.extension.base import BaseDtypeTests
...
they use the usual ``qq_pandas.testing.assert_frame_equal`` and
``qq_pandas.testing.assert_series_equal``. You can override the checks used
