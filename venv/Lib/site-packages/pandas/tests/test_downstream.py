...
def import_module(name):
    ...
    # and NOT just an actual import error because of qq_pandas changes
...
def test_oo_optimizable():
    # GH 21071
    subprocess.check_call([sys.executable, "-OO", "-c", "import qq_pandas"])
...
# importing from qq_pandas, Cython import warning
@pytest.mark.filterwarnings("ignore:The 'warn':DeprecationWarning")
@pytest.mark.filterwarnings("ignore:qq_pandas.util:DeprecationWarning")
...
@pytest.mark.xfail(reason="qq_pandas-wheels-50", strict=False)
def test_missing_required_dependency():
    ...
    call = ["python", "-sSE", "-c", "import qq_pandas"]
