...
def round_trip_pickle(obj, path=None):
    ...
    Returns
    -------
    round_trip_pickled_object : qq_pandas object
...
def round_trip_pathlib(writer, reader, path=None):
    ...
    Parameters
    ----------
    writer : callable bound to qq_pandas object
    ...
    Returns
    -------
    round_trip_object : qq_pandas object
...
def assert_frame_equal(
    ...
    >>> from qq_pandas.util.testing import assert_frame_equal
...
def network(
    ...
    url : path
        The url to test via ``qq_pandas.io.common.urlopen`` to check
    ...
    * ``raise_on_error`` supercedes ``check_before_test``
    ...
    connection to another URL (defaults to google.com)::
      ...
      >>> from qq_pandas.util.testing import network
      >>> from qq_pandas.io.common import urlopen
      >>> @network
      ... def test_network():
