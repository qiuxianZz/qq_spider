...
def read_pickle(path, compression="infer"):
    """
    Load pickled qq_pandas object (or any object) from file.
    ...
    Notes
    -----
    read_pickle is only guaranteed to be backwards compatible to qq_pandas 0.20.3.
    ...
    # 2) try pickle_compat (older qq_pandas version) to handle subclass changes
