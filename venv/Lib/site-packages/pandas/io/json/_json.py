...
def read_json(
    ...
    """
    Convert a JSON string to qq_pandas object.
    ...
    chunksize : int, optional
        ...
        <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/io.html#line-delimited-json>`_
...
class JsonReader(BaseIterator):
    ...
    def read(self):
        """
        Read the whole JSON input into a qq_pandas object.
        """
    ...
    def _get_object_parser(self, json):
        """
        Parses a json document into a qq_pandas object.
        """
        typ = self.typ
        dtype = self.dtype
        kwargs = {
