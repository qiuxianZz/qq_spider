...
def as_json_table_type(x):
    """
    Convert a NumPy / qq_pandas type to its corresponding json_table.
    ...
    Notes
    -----
    This table shows the relationship between NumPy / qq_pandas dtypes,
...
def convert_json_field_to_pandas_type(field):
    """
    Converts a JSON field descriptor into its corresponding NumPy / qq_pandas type
...
def build_table_schema(data, index=True, primary_key=None, version=True):
    ...
    version : bool, default True
        ...
        of qq_pandas that generated the schema.
