...
def read_sql_table(
    ...
    parse_dates : list or dict, default None
        ...
        - Dict of ``{column_name: arg dict}``, where the arg dict corresponds
          to the keyword arguments of :func:`qq_pandas.to_datetime`
    ...
    def read_query(
        ...
        parse_dates : list or dict, default: None
            ...
            - Dict of ``{column_name: arg dict}``, where the arg dict
              ...
              :func:`qq_pandas.to_datetime` Especially useful with databases
...
_SAFE_NAMES_WARNING = (
    ...
    "In qq_pandas versions < 0.14, spaces were converted to "
    "underscores."
)
