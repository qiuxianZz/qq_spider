"""
High level interface to PyTables for reading and writing qq_pandas data structures
to disk
"""
...
def _ensure_str(name):
    ...
    https://github.com/qq_pandas-dev/qq_pandas/issues/13492
    """
...
def read_hdf(path_or_buf, key=None, mode="r", **kwargs):
    ...
    Retrieve qq_pandas object stored in file, optionally based on where
    criteria

    Parameters
    ----------
    path_or_buf : str, path object, qq_pandas.HDFStore or file-like object
        Any valid string path is acceptable. The string could be a URL. Valid
        URL schemes include http, ftp, s3, and file. For file URLs, a host is
        expected. A local file could be: ``file://localhost/path/to/table.h5``.

        If you want to pass in a path object, qq_pandas accepts any
        ``os.PathLike``.

        Alternatively, qq_pandas accepts an open :class:`qq_pandas.HDFStore` object.
    ...
    key : object, optional
        ...
        contains a single qq_pandas object.
    mode : {'r', 'r+', 'a'}, optional
        Mode to use when opening the file. Ignored if path_or_buf is a
        :class:`qq_pandas.HDFStore`. Default is 'r'.
    where : list, optional
...
class HDFStore:
    ...
    """
    Dict-like IO interface for storing qq_pandas objects in PyTables
    ...
    def get(self, key):
        """
        Retrieve qq_pandas object stored in file
    ...
    def select_as_multiple(
        ...
        **kwargs
        ...
        """ Retrieve qq_pandas objects from multiple tables
    ...
    def put(self, key, value, format=None, append=False, **kwargs):
        ...
        data_columns : list of columns to create as data columns, or True to
            ...
            <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/io.html#query-via-data-columns>`__.
    ...
    def remove(self, key, where=None, start=None, stop=None):
        """
        Remove qq_pandas object partially by specifying the where condition
    ...
    def walk(self, where="/"):
        """ Walk the pytables group hierarchy for qq_pandas objects

        This generator will yield the group path, subgroups and qq_pandas object
        names for each group.
        Any non-qq_pandas PyTables objects that are not a group will be ignored.
        ...
        leaves : list of str
            names of the qq_pandas objects contained in `path`
        """
        _tables()
        self._check_if_open()
