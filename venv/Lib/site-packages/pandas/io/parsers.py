...
`IO Tools <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/io.html>`_.
...
index_col : int, str, sequence of int / str, or False, default ``None``
  ...
  Note: ``index_col=False`` can be used to force qq_pandas to *not* use the first
...
default False
    ...
    * dict, e.g. {{'foo' : [1, 3]}} -> parse columns 1, 3 as date and call
    ...
    :func:`qq_pandas.to_datetime` with ``utc=True``. See
    :ref:`io.csv.mixed_timezones` for more.

    Note: A fast-path exists for iso8601-formatted dates.
infer_datetime_format : bool, default False
    If True and `parse_dates` is enabled, qq_pandas will attempt to infer the
...
chunksize : int, optional
    ...
    <http://qq_pandas.pydata.org/qq_pandas-docs/stable/io.html#io-chunking>`_
...
def read_fwf(
    ...
    **kwds
    ...
    <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/io.html>`_.
