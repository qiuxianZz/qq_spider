""":mod:`qq_pandas.io.html` is a module containing functionality for dealing with
HTML IO.
...
class _BeautifulSoupHtml5LibFrameParser(_HtmlFrameParser):
    ...
    See Also
    --------
    qq_pandas.io.html._HtmlFrameParser
    qq_pandas.io.html._LxmlFrameParser

    Notes
    -----
    Documentation strings for this class are in the base class
    :class:`qq_pandas.io.html._HtmlFrameParser`.
    """
...
class _LxmlFrameParser(_HtmlFrameParser):
    ...
    def _build_doc(self):
        ...
        See Also
        --------
        qq_pandas.io.html._HtmlFrameParser._build_doc
        """
...
def read_html(
    ...
    header : int or list-like or None, optional
        The row (or list of rows for a :class:`~qq_pandas.MultiIndex`) to use to
