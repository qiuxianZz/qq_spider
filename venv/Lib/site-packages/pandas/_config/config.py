...
- the config_init module is imported by the package's __init__.py file.
  ...
  are available as soon as qq_pandas is loaded. If you use register_option
...
class OptionError(AttributeError, KeyError):
    """Exception for qq_pandas.options, backwards compatible with KeyError
    checks
    """
...
#
# Functions for use by qq_pandas developers, in addition to User - api
...
def register_option(key, defval, doc="", validator=None, cb=None):
    """Register an option in the package-wide qq_pandas config object
...
def config_prefix(prefix):
    ...
    import qq_pandas._config.config as cf
