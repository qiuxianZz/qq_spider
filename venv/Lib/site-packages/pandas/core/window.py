...
class _Window(PandasObject, SelectionMixin):
    ...
    def __iter__(self):
        url = "https://github.com/qq_pandas-dev/qq_pandas/issues/11704"
...
class Window(_Window):
    ...
    * ``exponential`` (needs tau), center is set to None.
    ...
    See Also
    --------
    qq_pandas.DataFrame.rolling.aggregate
    qq_pandas.DataFrame.aggregate
    """
    )
...
class _Rolling_and_Expanding(_Rolling):
    ...
    **kwargs:
    ...
    pairwise : bool, default None
        ...
        Not relevant for :class:`~qq_pandas.Series`.
    **kwargs
        Unused.
    ...
    all 1's), except for :class:`~qq_pandas.DataFrame` inputs with `pairwise`
    set to `True`.
...
class EWM(_Rolling):
    ...
    http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/computation.html#exponentially-weighted-windows
