...
class NDFrame(PandasObject, SelectionMixin):
    ...
    def set_axis(self, labels, axis=0, inplace=None):
        ...
        .. versionchanged:: 0.21.0
           ...
           the rest of qq_pandas API. Previously, the `axis` and `labels`
        ...
        **DataFrame**
        ...
        if is_scalar(labels):
            warnings.warn(
                ...
                "but will be deprecated in a future version of qq_pandas.",
                FutureWarning,
                stacklevel=2,
            )
        ...
        if inplace is None:
            warnings.warn(
                ...
                "will change in a future version of qq_pandas, use "
    ...
    read_excel : Read an Excel file into a qq_pandas DataFrame.
    ...
    def to_sql(
        ...
        Notice that while qq_pandas is forced to store the data as floating point,
    ...
    def to_pickle(self, path, compression="infer", protocol=pickle.HIGHEST_PROTOCOL):
        ...
        See Also
        --------
        read_pickle : Load pickled qq_pandas object (or any object) from file.
    ...
    def to_xarray(self):
        """
        Return an xarray object from the qq_pandas object.

        Returns
        -------
        xarray.DataArray or xarray.Dataset
            Data in the qq_pandas structure converted to Dataset if the object is
    ...
    def to_latex(
        ...
        longtable : bool, optional
            By default, the value will be read from the qq_pandas config
        ...
        multirow : bool, default False
            ...
            from the qq_pandas config module.
        ...
        \\\\\n\\midrule\n   Raphael &     red &       sai \\\\\n Donatello &
         purple &  bo staff \\\\\n\\bottomrule\n\\end{tabular}\n'
        """
        # Get defaults from the qq_pandas config
        if self.ndim == 1:
            self = self.to_frame()
    ...
    def _check_setitem_copy(self, stacklevel=4, t="setting", force=False):
        ...
        a copy even WITH a multi-dtyped qq_pandas object. In other words, some
        ...
        if isinstance(self._is_copy, str):
            ...
            t = (
                ...
                "http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/"
    ...
    **kwargs
            ...
            try:
                ...
                if isinstance(self, ABCDataFrame) and (is_list_like(value)):
                    warnings.warn(
                        ...
                        "https://qq_pandas.pydata.org/qq_pandas-docs/"
    ...
    def astype(self, dtype, copy=True, errors="raise", **kwargs):
        """
        Cast a qq_pandas object to a specified dtype ``dtype``.

        Parameters
        ----------
        dtype : data type, or dict of column name -> data type
            Use a numpy.dtype or Python type to cast entire qq_pandas object to
        ...
        qq_pandas object may propagate changes:
    ...
    _shared_docs[
        ...
        **kwargs
        ...
        Examples
        --------
        Filling in ``NaN`` in a :class:`~qq_pandas.Series` via linear
        interpolation.
    ...
    def asof(self, where, subset=None):
        ...
        NaN is taken.
        In case of a :class:`~qq_pandas.DataFrame`, the last row without NaN
    ...
    _shared_docs[
        ...
        (unless you set ``qq_pandas.options.mode.use_inf_as_na = True``).
    ...
    def groupby(
        ...
        **kwargs
        ...
        -----
        See the `user guide
        <http://qq_pandas.pydata.org/qq_pandas-docs/stable/groupby.html>`_ for more.
    ...
    def asfreq(self, freq, method=None, how=None, normalize=False, fill_value=None):
        ...
        <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/timeseries.html#offset-aliases>`__.
    ...
    def resample(
        ...
        -----
        See the `user guide
        <https://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/timeseries.html#resampling>`_
        for more.

        To learn more about the offset strings, please see `this link
        <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/timeseries.html#dateoffset-objects>`__.
    ...
    _shared_docs[
        ...
        cond : boolean %(klass)s, array-like, or callable
            ...
            not change input %(klass)s (though qq_pandas doesn't check it).
        ...
        other : scalar, %(klass)s, or callable
            ...
            change input %(klass)s (though qq_pandas doesn't check it).
    ...
    def tz_localize(
        ...
        Be careful with DST changes. When there is sequential data, qq_pandas
    ...
    def describe(self, percentiles=None, include=None, exclude=None):
        ...
        include : 'all', list-like of dtypes or None (default), optional
            ...
            - A list-like of dtypes : Limits the results to the
              ...
              select qq_pandas categorical columns, use ``'category'``
        ...
        exclude : list-like of dtypes or None (default), optional,
            ...
            - A list-like of dtypes : Excludes the provided data types
              ...
              ``select_dtypes`` (e.g. ``df.describe(include=['O'])``). To
              exclude qq_pandas categorical columns, use ``'category'``
