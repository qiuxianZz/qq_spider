"""
Base and utility classes for qq_pandas objects.
"""
import builtins
...
class PandasObject(DirNamesMixin):
    ...
    """baseclass for various qq_pandas objects"""
...
class IndexOpsMixin:
    ...
    def to_numpy(self, dtype=None, copy=False):
        ...
        ``to_numpy()`` for various dtypes within qq_pandas.
        ...
        Use ``dtype=object`` to return an ndarray of qq_pandas :class:`Timestamp`
