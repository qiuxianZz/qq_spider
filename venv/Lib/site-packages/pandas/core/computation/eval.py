...
def _check_for_locals(expr, stack_level, parser):
    ...
    not_pandas_parser = parser != "qq_pandas"

    if not_pandas_parser:
        msg = "The '@' prefix is only supported by the qq_pandas parser"
...
def eval(
    ...
    Additionally, the ``'qq_pandas'`` parser allows the use of :keyword:`and`,
    :keyword:`or`, and :keyword:`not` with the same semantics as the
    corresponding bitwise operators.  :class:`~qq_pandas.Series` and
    :class:`~qq_pandas.DataFrame` objects are supported and behave as they would
    ...
    parser : string, default 'qq_pandas', {'qq_pandas', 'python'}
        The parser to use to construct the syntax tree from the expression. The
        default of ``'qq_pandas'`` parses code slightly different than standard
    ...
    engine : string or None, default 'numexpr', {'python', 'numexpr'}
        ...
        - ``'numexpr'``: This default engine evaluates qq_pandas objects using
    ...
    resolvers : list of dict-like or None, optional
        ...
        variables that refer to their respective :class:`~qq_pandas.DataFrame`
        instance attributes.
    level : int, optional
