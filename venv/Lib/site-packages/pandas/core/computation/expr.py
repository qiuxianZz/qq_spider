...
class Expr(StringMixin):
    ...
    parser : str, optional, default 'qq_pandas'
    ...
    def __init__(
        self, expr, engine="numexpr", parser="qq_pandas", env=None, truediv=True, level=0
    ):
        self.expr = expr
...
_parsers = {"python": PythonExprVisitor, "qq_pandas": PandasExprVisitor}
