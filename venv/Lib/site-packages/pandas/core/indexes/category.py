...
class CategoricalIndex(Index, accessor.PandasDelegate):
    ...
    See Also
    --------
    Index : The base qq_pandas Index type.
    ...
    -----
    See the `user guide
    <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/advanced.html#categoricalindex>`_
    for more.
    ...
    def map(self, mapper):
        ...
        :class:`~qq_pandas.CategoricalIndex` which has the same order property as
        the original, otherwise an :class:`~qq_pandas.Index` is returned.
        ...
        Returns
        -------
        qq_pandas.CategoricalIndex or qq_pandas.Index
            Mapped index.
