...
class MultiIndex(Index):
    """
    A multi-level, or hierarchical, index object for qq_pandas objects.
    ...
    -----
    See the `user guide
    <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/advanced.html>`_
    for more.
    ...
    def copy(
        ...
        **kwargs
        ...
        dtype : numpy dtype or qq_pandas type, optional
