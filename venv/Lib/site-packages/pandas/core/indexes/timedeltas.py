...
class TimedeltaIndex(
    ...
    freq : string or qq_pandas offset object, optional
        One of qq_pandas date offset strings or corresponding objects. The string
    ...
    def __new__(
        ...
        if data is None:
            ...
            warnings.warn(
                ...
                "`qq_pandas.timedelta_range` instead.",
                FutureWarning,
                stacklevel=2,
            )
    ...
    def astype(self, dtype, copy=True):
        ...
        if is_timedelta64_dtype(dtype) and not is_timedelta64_ns_dtype(dtype):
            ...
            #  so that we can return a numeric index, since qq_pandas will return
