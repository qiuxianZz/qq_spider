...
that can be mixed into or pinned onto other qq_pandas classes.
...
Notes
-----
When accessed, your accessor will be initialized with the qq_pandas object
...
For consistency with qq_pandas methods, you should raise an ``AttributeError``
