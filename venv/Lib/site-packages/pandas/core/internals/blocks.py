...
class Block(PandasObject):
    """
    Canonical n-dimensional unit of homogeneous dtype contained in a qq_pandas
    data structure
...
class ExtensionBlock(NonConsolidatableMixIn, Block):
    ...
    def formatting_values(self):
        ...
        # Do the warning here, it's only user in qq_pandas, since we
...
class ObjectBlock(Block):
    ...
    def _try_coerce_args(self, other):
        ...
        if isinstance(other, DatetimeArray):
            # hit in qq_pandas/tests/indexing/test_coercion.py
...
class CategoricalBlock(ExtensionBlock):
    ...
    def where(self, other, cond, align=True, errors="raise", try_cast=False, axis=0):
        ...
        object_msg = (
            ...
            "categorical's categories. A future version of qq_pandas will raise "
...
def get_block_type(values, dtype=None):
    ...
    ----------
    values : ndarray-like
    dtype : numpy or qq_pandas dtype
