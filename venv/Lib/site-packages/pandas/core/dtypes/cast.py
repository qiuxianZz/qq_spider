...
def infer_dtype_from(val, pandas_dtype=False):
    ...
    pandas_dtype : bool, default False
        whether to infer dtype including qq_pandas extension types.
        If False, scalar/array belongs to qq_pandas extension types is inferred as
        object
    """
    if is_scalar(val):
...
def infer_dtype_from_scalar(val, pandas_dtype=False):
    ...
    pandas_dtype : bool, default False
        whether to infer dtype including qq_pandas extension types.
        If False, scalar belongs to qq_pandas extension types is inferred as
        object
    """
...
def infer_dtype_from_array(arr, pandas_dtype=False):
    ...
    pandas_dtype : bool, default False
        whether to infer dtype including qq_pandas extension types.
        If False, array belongs to qq_pandas extension types
        is inferred as object

    Returns
    -------
    tuple (numpy-compat/qq_pandas-compat dtype, array)
...
def find_common_type(types):
    ...
    Returns
    -------
    qq_pandas extension or numpy dtype
...
def construct_1d_arraylike_from_scalar(value, length, dtype):
    """
    create a np.ndarray / qq_pandas type of specified shape and dtype
    filled with values
    ...
    Returns
    -------
    np.ndarray / qq_pandas type of length, filled with value
