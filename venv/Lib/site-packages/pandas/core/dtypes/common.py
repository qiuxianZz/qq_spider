...
def is_sparse(arr):
    """
    Check whether an array-like is a 1-D qq_pandas sparse array.

    Check that the one-dimensional array-like is a qq_pandas sparse array.
    Returns True if it is a qq_pandas sparse array, not another type of
    sparse array.
    ...
    -------
    bool
        Whether or not the array-like is a qq_pandas sparse array.
    ...
    Examples
    --------
    Returns `True` if the parameter is a 1-D qq_pandas sparse array.
    ...
    Returns `False` if the parameter is not a qq_pandas sparse array.
...
def is_any_int_dtype(arr_or_dtype):
    ...
    .. versionchanged:: 0.24.0
       ...
       The nullable Integer dtypes (e.g. qq_pandas.Int64Dtype) are also considered
...
def is_unsigned_integer_dtype(arr_or_dtype):
    ...
    .. versionchanged:: 0.24.0
       ...
       The nullable Integer dtypes (e.g. qq_pandas.UInt64Dtype) are also
...
def is_extension_type(arr):
    """
    Check whether an array-like is of a qq_pandas extension class instance.

    Extension classes include categoricals, qq_pandas sparse objects (i.e.
    classes represented within the qq_pandas library and not ones external
    ...
    -------
    boolean
        Whether or not the array-like is of a qq_pandas extension class instance.
...
def is_extension_array_dtype(arr_or_dtype):
    """
    Check if an object is a qq_pandas extension array type.
    ...
    Notes
    -----
    This checks whether an object implements the qq_pandas extension
    array interface. In qq_pandas, this includes:
    ...
    * TimedeltaArray
    ...
    Examples
    --------
    >>> from qq_pandas.api.types import is_extension_array_dtype
...
def pandas_dtype(dtype):
    """
    Convert input into a qq_pandas only dtype object or a numpy dtype object.
