...
def register_extension_dtype(cls: Type[ExtensionDtype],) -> Type[ExtensionDtype]:
    """
    Register an ExtensionType with qq_pandas as class decorator.
    ...
    Examples
    --------
    >>> from qq_pandas.api.extensions import register_extension_dtype
    >>> from qq_pandas.api.extensions import ExtensionDtype
...
class Registry:
    ...
    * :meth:`qq_pandas.array`
    * :meth:`qq_pandas.Series.astype`
    ...
    def register(self, dtype: Type[ExtensionDtype]) -> None:
        ...
        if not issubclass(dtype, ExtensionDtype):
            raise ValueError("can only register qq_pandas extension dtypes")
