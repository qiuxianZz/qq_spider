"""
This module is imported from the qq_pandas package __init__.py file
...
: int
    ...
    equals 'truncate' this can be set to 0 and qq_pandas will auto-detect
...
: int
    This sets the maximum number of categories qq_pandas should output when
...
: boolean
    ...
    qq_pandas objects (if it is available).
"""
...
: int
    ...
    a qq_pandas data structure. When the column overflows, a "..."
...
: int
    ...
    a terminal this can be set to None and qq_pandas will correctly auto-detect
    the width.
...
: 'truncate'/'info'
    ...
    df.info() (the behaviour in earlier versions of qq_pandas).
"""
...
: str
    ...
    backend provided with qq_pandas. Other backends can be specified by
...
def register_plotting_backend_cb(key):
    ...
    try:
        ...
        raise ValueError(
            ...
            "A qq_pandas plotting backend must be a module that "
...
: bool
    ...
    the converters, restoring any converters that qq_pandas overwrote.
"""
