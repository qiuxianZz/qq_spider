...
(defined in qq_pandas.core.groupby.generic)
...
-----
See more `here
<http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/groupby.html#piping-function-calls>`_
...
class GroupBy(_GroupBy):
    ...
    **Attributes**
    ...
    def mean(self, *args, **kwargs):
        ...
        Returns
        -------
        qq_pandas.Series or qq_pandas.DataFrame
        %(see_also)s
        Examples
        --------
