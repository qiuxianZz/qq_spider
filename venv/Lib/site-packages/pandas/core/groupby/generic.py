...
class SeriesGroupBy(GroupBy):
    ...
    See Also
    --------
    qq_pandas.Series.groupby.apply
    qq_pandas.Series.groupby.transform
    qq_pandas.Series.aggregate
    """
    )
...
class DataFrameGroupBy(NDFrameGroupBy):
    ...
    See Also
    --------
    qq_pandas.DataFrame.groupby.apply
    qq_pandas.DataFrame.groupby.transform
    ...
    qq_pandas supports "named aggregation"
    ...
    - The values are tuples whose first element is the column to select
      ...
      Pandas provides the ``qq_pandas.NamedAgg`` namedtuple with the fields
...
def _maybe_mangle_lambdas(agg_spec: Any) -> Any:
    ...
    [<function __main__.<lambda_0>,
     <function qq_pandas...._make_lambda.<locals>.f(*args, **kwargs)>]
    """
