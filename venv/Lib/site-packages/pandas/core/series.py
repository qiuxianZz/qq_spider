...
class Series(base.IndexOpsMixin, generic.NDFrame):
            ...
            if lib.is_scalar(result):
                ...
                if method == "outer":
                    msg = (
                        ...
                        "qq_pandas objects. Returning an ndarray, but in the "
    ...
    def duplicated(self, keep="first"):
        ...
        See Also
        --------
        Index.duplicated : Equivalent method on qq_pandas.Index.
    ...
    def combine(self, other, func, fill_value=None):
        ...
        if is_categorical_dtype(self.values):
            ...
            try:
                ...
                # qq_pandas has no control over what 3rd-party ExtensionArrays
