...
def _maybe_match_name(a, b):
    ...
    See Also
    --------
    qq_pandas.core.common.consensus_name_attr
    """
...
def maybe_upcast_for_op(obj):
    """
    Cast non-qq_pandas objects to qq_pandas types to unify behavior of arithmetic
        ...
        if isinstance(other, ABCDataFrame):  # pragma: no cover
            ...
            if isinstance(other, datetime.date) and not isinstance(
                ...
                msg = (
                    ...
                    "datetime. In the future qq_pandas will not coerce, "
                    "and {future}. "
