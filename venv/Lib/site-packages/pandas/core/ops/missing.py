...
In particular, qq_pandas conventions regarding divison by zero differ
from numpy in the following ways:
    1) np.array([-1, 0, 1], dtype=dtype1) // np.array([0, 0, 0], dtype=dtype2)
       ...
       qq_pandas convention is to return [-inf, nan, inf] for all dtype
       combinations.
    ...
    2) np.array([-1, 0, 1], dtype=dtype1) % np.array([0, 0, 0], dtype=dtype2)
       ...
       qq_pandas convention is to return [nan, nan, nan] for all dtype
       combinations.
