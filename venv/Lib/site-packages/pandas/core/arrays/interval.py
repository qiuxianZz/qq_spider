...
-----
See the `user guide
<http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/advanced.html#intervalindex>`_
for more.
    ...
    def fillna(self, value=None, method=None, limit=None):
        ...
        if not isinstance(value, ABCInterval):
            msg = (
                ...
                "scalar 'qq_pandas.Interval'. Got a '{}' instead.".format(
                    type(value).__name__
                )
            )
            raise TypeError(msg)
    ...
    def take(self, indices, allow_fill=False, fill_value=None, axis=None, **kwargs):
        ...
        if allow_fill:
            if fill_value is None:
                ...
                msg = (
                    "'IntervalArray.fillna' only supports filling with a "
                    "'scalar qq_pandas.Interval or NA'. Got a '{}' instead.".format(
