...
_i8_message = """
    ...
    will be interpreted differently in a future version of qq_pandas. Previously,
...
class DatetimeArray(dtl.DatetimeLikeArrayMixin, dtl.TimelikeOps, dtl.DatelikeOps):
    ...
    def dtype(self) -> Union[np.dtype, DatetimeTZDtype]:
        ...
        .. warning::
           ...
           A future version of qq_pandas will change dtype to never be a
...
default 'raise'
        ...
        Be careful with DST changes. When there is sequential data, qq_pandas can
        infer the DST time:
    ...
    def to_period(self, freq=None):
        ...
        ----------
        freq : str or Offset, optional
            One of qq_pandas' :ref:`offset strings <timeseries.offset_aliases>`
...
def sequence_to_dt64ns(
    ...
    ambiguous : str, bool, or arraylike, default 'raise'
        See qq_pandas._libs.tslibs.conversion.tz_localize_to_utc
...
def _validate_dt64_dtype(dtype):
    ...
    dtype or a qq_pandas DatetimeTZDtype.
