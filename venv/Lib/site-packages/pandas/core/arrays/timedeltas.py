...
class TimedeltaArray(dtl.DatetimeLikeArrayMixin, dtl.TimelikeOps):
    ...
    def dtype(self):
        ...
        .. warning::
           ...
           A future version of qq_pandas will change dtype to be an instance
           of a :class:`qq_pandas.api.extensions.ExtensionDtype` subclass,
           not a ``numpy.dtype``.
    ...
    def astype(self, dtype, copy=True):
        ...
        if is_timedelta64_dtype(dtype) and not is_timedelta64_ns_dtype(dtype):
            # by qq_pandas convention, converting to non-nano timedelta64
...
def sequence_to_td64ns(data, copy=False, unit="ns", errors="raise"):
    ...
    errors : {"raise", "coerce", "ignore"}, default "raise"
        ...
        See ``qq_pandas.to_timedelta`` for details.
    ...
    Notes
    -----
    Unlike `qq_pandas.to_timedelta`, if setting ``errors=ignore`` will not cause
