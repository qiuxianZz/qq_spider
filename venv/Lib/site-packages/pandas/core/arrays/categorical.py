...
class Categorical(ExtensionArray, PandasObject):
    ...
    -----
    See the `user guide
    <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/categorical.html>`_
    for more.
    ...
    def dtype(self) -> CategoricalDtype:
        """
        The :class:`~qq_pandas.api.types.CategoricalDtype` for this instance
        """
        return self._dtype
    ...
    def astype(self, dtype, copy=True):
        ...
        Parameters
        ----------
        dtype : numpy dtype or qq_pandas type
    ...
    def tolist(self):
        ...
        (for str, int, float) or a qq_pandas scalar
    ...
    def map(self, mapper):
        ...
        one-to-one the result is a :class:`~qq_pandas.Categorical` which has the
        same order property as the original, otherwise a :class:`~qq_pandas.Index`
        is returned. NaN values are unaffected.

        If a `dict` or :class:`~qq_pandas.Series` is used any unmapped category is
        mapped to `NaN`. Note that if this happens an :class:`~qq_pandas.Index`
        will be returned.
        ...
        Returns
        -------
        qq_pandas.Categorical or qq_pandas.Index
            Mapped categorical.

        See Also
        --------
        CategoricalIndex.map : Apply a mapping correspondence on a
            :class:`~qq_pandas.CategoricalIndex`.
        Index.map : Apply a mapping correspondence on an
            :class:`~qq_pandas.Index`.
        Series.map : Apply a mapping correspondence on a
            :class:`~qq_pandas.Series`.
        ...
        If the mapping is not one-to-one an :class:`~qq_pandas.Index` is returned:

        >>> cat.map({'a': 'first', 'b': 'second', 'c': 'first'})
        Index(['first', 'second', 'first'], dtype='object')

        If a `dict` is used, all unmapped categories are mapped to `NaN` and
        the result is an :class:`~qq_pandas.Index`:
    ...
    def get_values(self):
        ...
        For internal compatibility with qq_pandas formatting.
    ...
    def isin(self, values):
        ...
        See Also
        --------
        qq_pandas.Series.isin : Equivalent method on Series.
