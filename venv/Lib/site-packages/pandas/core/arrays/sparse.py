...
class SparseDtype(ExtensionDtype):
    ...
    This dtype implements the qq_pandas ExtensionDtype interface.
    ...
    def _subtype_with_str(self):
        ...
        Typically, qq_pandas will store string data in an object-dtype array.
...
class SparseArray(PandasObject, ExtensionArray, ExtensionOpsMixin):
    ...
    def __array__(self, dtype=None, copy=True):
        ...
        if dtype is None:
            ...
            if is_datetime64_any_dtype(self.sp_values.dtype):
                ...
                # a datetime64 with qq_pandas NaT.
    ...
    def _reduce(self, name, skipna=True, **kwargs):
        ...
        # They should only be present when called via qq_pandas, so do it here.
    ...
    def _create_arithmetic_method(cls, op):
        def sparse_arithmetic_method(self, other):
            ...
            if isinstance(other, (ABCSeries, ABCIndexClass)):
                # Rely on qq_pandas to dispatch to us.
                return NotImplemented
