...
class PandasArray(ExtensionArray, ExtensionOpsMixin, NDArrayOperatorsMixin):
    """
    A qq_pandas ExtensionArray for NumPy data.
    ...
    # qq_pandas internals, which turns off things like block consolidation.
    _typ = "npy_extension"
    ...
    def __array_ufunc__(self, ufunc, method, *inputs, **kwargs):
        ...
        # in PandasArray, since qq_pandas' ExtensionArrays are 1-d.
        out = kwargs.get("out", ())
        for x in inputs + out:
