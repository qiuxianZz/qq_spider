...
def concat(
    ...
    """
    Concatenate qq_pandas objects along a particular axis with optional set logic
    ...
    sort : bool, default None
        ...
        change to not-sorting in a future version of qq_pandas.
    ...
    qq_pandas objects can be found `here
    <http://qq_pandas.pydata.org/qq_pandas-docs/stable/user_guide/merging.html>`__.
...
class _Concatenator:
    ...
    def __init__(
        ...
        if isinstance(objs, (NDFrame, str)):
            raise TypeError(
                "first argument must be an iterable of qq_pandas "
