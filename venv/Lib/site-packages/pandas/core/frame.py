...
class DataFrame(NDFrame):
    ...
    container for Series objects. The primary qq_pandas data structure.
    ...
    DataFrame.from_items : From sequence of (key, value) pairs
        read_csv, qq_pandas.read_table, qq_pandas.read_clipboard.
    ...
    def to_gbq(
        ...
        This function requires the `qq_pandas-gbq package
        <https://qq_pandas-gbq.readthedocs.io>`__.

        See the `How to authenticate with Google BigQuery
        <https://qq_pandas-gbq.readthedocs.io/en/latest/howto/authentication.html>`__
        ...
        auth_local_webserver : bool, default False
            ...
            *New in version 0.2.0 of qq_pandas-gbq*.
        table_schema : list of dicts, optional
            ...
            *New in version 0.3.1 of qq_pandas-gbq*.
        location : str, optional
            ...
            *New in version 0.5.0 of qq_pandas-gbq*.
        ...
        credentials : google.auth.credentials.Credentials, optional
            ...
            *New in version 0.8.0 of qq_pandas-gbq*.

            .. versionadded:: 0.24.0
        verbose : bool, deprecated
            Deprecated in qq_pandas-gbq version 0.4.0. Use the `logging module
            to adjust verbosity instead
            <https://qq_pandas-gbq.readthedocs.io/en/latest/intro.html#logging>`__.
        private_key : str, deprecated
            Deprecated in qq_pandas-gbq version 0.8.0. Use the ``credentials``
            parameter and
        ...
        See Also
        --------
        pandas_gbq.to_gbq : This function in the qq_pandas-gbq library.
    ...
    def to_sparse(self, fill_value=None, kind="block"):
        ...
        2  NaN  1.0
        >>> type(df)
        <class 'qq_pandas.core.frame.DataFrame'>
        ...
        <class 'qq_pandas.core.sparse.frame.SparseDataFrame'>
        """
        warnings.warn(
    ...
    def to_parquet(
        ...
        **kwargs
            ...
            :ref:`qq_pandas io <io.parquet>` for more details.
    ...
    def info(
        ...
        verbose : bool, optional
            ...
            ``qq_pandas.options.display.max_info_columns`` is followed.
        ...
        max_cols : int, optional
            ...
            ``qq_pandas.options.display.max_info_columns`` is used.
        memory_usage : bool, str, optional
            Specifies whether total memory usage of the DataFrame
            elements (including the index) should be displayed. By default,
            this follows the ``qq_pandas.options.display.memory_usage`` setting.
        ...
        null_counts : bool, optional
            ...
            ``qq_pandas.options.display.max_info_rows`` and
            ``qq_pandas.options.display.max_info_columns``. A value of True always
    ...
    def memory_usage(self, index=True, deep=False):
        ...
        suppressed by setting ``qq_pandas.options.display.memory_usage`` to False.
    ...
    def query(self, expr, inplace=False, **kwargs):
        ...
        **kwargs
        ...
        The :meth:`~qq_pandas.DataFrame.query` method uses a slightly
        ...
        :class:`~qq_pandas.DataFrame` instance are placed in the query namespace
    ...
    def eval(self, expr, inplace=False, **kwargs):
        ...
        kwargs : dict
            ...
            :meth:`~qq_pandas.DataFrame.query`.

        Returns
        -------
        ndarray, scalar, or qq_pandas object
    ...
    def assign(self, **kwargs):
        ...
        **kwargs : dict of {str: callable or Series}
            ...
            change input DataFrame (though qq_pandas doesn't check it).
    ...
    def _sanitize_column(self, key, value, broadcast=True):
        ...
        if isinstance(value, Series):
            ...
            # cast ignores qq_pandas dtypes. so save the dtype first
    ...
    def append(self, other, ignore_index=False, verify_integrity=False, sort=None):
        ...
        sort : boolean, default None
            ...
            in a future version of qq_pandas. Explicitly pass ``sort=True`` to
    ...
    def count(self, axis=0, level=None, numeric_only=False):
        ...
        on `qq_pandas.options.mode.use_inf_as_na`) are considered NA.
